...
const cell = (id: string, overrides: Partial<Cell> = {}): Cell => ({
  id, index: 0, title: id, category: null, printed: false, obsolete: false, base: true, out_of_scope: false, moved: false, year_from: null, year_to: null, sets: null, colors: null, tags: [],
